...
local txt = require("core.tabufline.utils").txt
local btn = require("core.tabufline.utils").btn
local strep = string.rep
local style_buf = require("core.tabufline.utils").style_buf
...
vim.cmd([[
  function! TbGoToBuf(bufnr,b,c,d)
    call luaeval('require("core.tabufline").goto_buf(_A)', a:bufnr)
  endfunction]])

vim.cmd([[
  function! TbKillBuf(bufnr,b,c,d) 
    call luaeval('require("core.tabufline").close_buffer(_A)', a:bufnr)
  endfunction]])

vim.cmd("function! TbNewTab(a,b,c,d) \n tabnew \n endfunction")
vim.cmd("function! TbGotoTab(tabnr,b,c,d) \n execute a:tabnr ..'tabnext' \n endfunction")
vim.cmd("function! TbCloseAllBufs(a,b,c,d) \n lua require('core.tabufline').closeAllBufs() \n endfunction")
